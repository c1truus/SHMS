...
#include <memory>
#include "../../../inc/registrationwindow.h"
...
QT_MOC_LITERAL(1, 19, 22), // "registrationSuccessful"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 25), // "on_registerButton_clicked"
QT_MOC_LITERAL(4, 69, 28) // "on_backToLoginButton_clicked"

    },
    "registrationwindow\0registrationSuccessful\0"
...
void registrationwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (registrationwindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&registrationwindow::registrationSuccessful)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void registrationwindow::registrationSuccessful()
{
